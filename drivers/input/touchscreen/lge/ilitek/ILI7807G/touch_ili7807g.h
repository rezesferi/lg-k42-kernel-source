...
#define ILI7807G_PC_ADDR		0x44008
#define ILI7807G_LATCH_ADDR		0x51010
...
extern void ili7807g_get_pc_latch(struct device *dev);
...
extern void ili7807g_get_trans_report(struct device *dev);
...
extern void ili7807g_get_ddi_reg_onepage(u8 page, u8 reg, u8 *data);
