...
#define PT_FRAME_1_OFFSET		(0x1046)	//(0x1240)
#define PT_FRAME_2_OFFSET		(0x11B7)	//(0x1384)
#define PT_FRAME_3_OFFSET		(0x1328)	//(0x14C8)
#define PT_FRAME_4_OFFSET		(0x1499)	//(0x160C)


/* Firmware debugging */
#define AIT_RAW_DATA_OFFSET			(0x1046)//(0x12B6)	
#define DELTA_DATA_OFFSET			(0x1328)//(0x153E)	
#define LABLE_DATA_OFFSET			(0x14D6)//(0x16BA)	
#define AIT_BASE_DATA_OFFSET		(0x11B7)//(0x13FA)	
#define AIT_DEBUG_BUF_DATA_OFFSET	(0x15AD)//(0x102E)
...
/* Chanel settings */
#define MAX_CHANNEL		(41)
#define ROW_SIZE		(41)	//36
#define COL_SIZE		(18)	//18
