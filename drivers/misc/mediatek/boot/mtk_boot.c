...
static DRIVER_ATTR_RW(meta_com_type_info);
...
static ssize_t meta_com_id_info_store(struct device_driver *driver, const char *buf,
	size_t count)
{
	/*Do nothing */
	return count;
...
static DRIVER_ATTR_RW(meta_com_id_info);
...
static DRIVER_ATTR_RW(meta_uart_port_info);
