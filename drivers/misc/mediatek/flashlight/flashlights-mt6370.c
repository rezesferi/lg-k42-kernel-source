...
#ifdef CONFIG_LGE_PM
static int mt6370_force_input_supply(int enable)
{
	union power_supply_propval prop;
	static struct power_supply *chg_psy;
	int ret;
...
#if defined(CONFIG_MACH_MT6765_EH20LM)
...
#elif defined(CONFIG_MACH_MT6765_FH10LM)
static const unsigned char mt6370_torch_level_CH1[MT6370_LEVEL_TORCH] = {
	0x00, 0x00, 0x01, 0x02, 0x03, 0x04, /*0x05*/0x08, 0x06, 0x07, 0x08,
	0x10, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E
};
...
#elif defined(CONFIG_MACH_MT6765_DH35LM)
static const unsigned char mt6370_torch_level_CH1[MT6370_LEVEL_TORCH] = {
	0x00, 0x02, 0x04, 0x06, 0x08, 0x0A, 0x0A, 0x0E, 0x10, 0x12,
	0x14, 0x16, 0x18, 0x1A, 0x1C, 0x1E
};
...
#if defined(CONFIG_MACH_MT6762_MH45LM) || defined(CONFIG_MACH_MT6765_EH35LM) || defined(CONFIG_MACH_MT6765_DH35LM)
