...
static kal_uint8 gc2375h_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint8 addr_data_pair_init_gc2375h[] = {
	0xfe, 0x00,
	0xfe, 0x00,
	0xfe, 0x00,
	0xf7, 0x01,
...
static void sensor_init(void)
{
	...
	gc2375h_table_write_cmos_sensor(
		addr_data_pair_init_gc2375h,
		sizeof(addr_data_pair_init_gc2375h) /
		sizeof(kal_uint8));
#else
	/* System */
	write_cmos_sensor(0xfe, 0x00);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			pr_err("wyh gc2375h i2c write sensor id : 0x%x\n", *sensor_id);
			if (*sensor_id == imgsensor_info.sensor_id) {
                strcpy(aux_sensor_name, "gc2375h_jsl");/*LGE_CHANGE, 2019-07-04, add the camera identifying logic , kyunghun.oh@lge.com*/
