...
#endif
#if defined(HI1333_LGIT_MIPI_RAW)
	{
		SENSOR_DRVNAME_HI1333_LGIT_MIPI_RAW,
		{
            {DOVDD, Vol_1800, 1},
            {AVDD, Vol_2800, 1},
            {DVDD, Vol_1200, 1},
...
#endif
#if defined(SL556_3M_MIPI_RAW)
	{
		SENSOR_DRVNAME_SL556_3M_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
			{DVDD, Vol_1200, 1},
...
#endif
#if defined(SL556REAR_MIPI_RAW)
	{
		SENSOR_DRVNAME_SL556REAR_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
			{DVDD, Vol_1200, 1},
