...
extern char macro_sensor_name[20];/*LGE_CHANGE, 2021-01-21, add the camera identifying logic , youmi.jun@lge.com*/
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				strcpy(macro_sensor_name, "gc02m1");/*LGE_CHANGE, 2021-01-21, add the camera identifying logic , youmi.jun@lge.com*/
