...
extern char depth_sensor_name[20];/*LGE_CHANGE, 2021-01-21, add the camera identifying logic , youmi.jun@lge.com*/
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			strcpy(depth_sensor_name, "gc02m1b");/*LGE_CHANGE, 2021-01-21, add the camera identifying logic , youmi.jun@lge.com*/
			#if 0
