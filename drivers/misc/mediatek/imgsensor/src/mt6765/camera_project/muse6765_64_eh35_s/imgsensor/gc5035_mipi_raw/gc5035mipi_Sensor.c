...
extern char wide_sensor_name[20];/*LGE_CHANGE, 2021-01-21, add the camera identifying logic , youmi.jun@lge.com*/
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				strcpy(wide_sensor_name, "gc5035");/*LGE_CHANGE, 2021-01-21, add the camera identifying logic , youmi.jun@lge.com*/
				gc5035_otp_identify();
				cam_pr_debug("i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
