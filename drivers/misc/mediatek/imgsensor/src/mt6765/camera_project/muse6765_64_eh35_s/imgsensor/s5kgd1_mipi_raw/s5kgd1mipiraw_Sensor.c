...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.ihdr_support = 0,
	.ihdr_le_firstline = 0,
	.sensor_mode_num = 7,//LGE_CHANGE, 2021-10-20, Fix for Front camera remosaic capture not working,bharatkumar.v@lge.com
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001));
			if (*sensor_id == imgsensor_info.sensor_id) {
				strcpy(front_sensor_name, "s5kgd1");/*LGE_CHANGE, 2021-01-21, add the camera identifying logic , youmi.jun@lge.com*/
