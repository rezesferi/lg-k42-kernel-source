...
int GT9772AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	...
	if (*g_pAF_Opened == 2) {
		LOG_INF("Wait\n");
		LOG_INF("_Shamyu__ g_u4CurrPosition - %ld\n", g_u4CurrPosition);
		// LGE_Change_S, Fix for Camera AF tick noise issue TDID#76630, ranjith.k@lge.com - 18th Nov 2020
		#if 0
		...
		msleep(10);
		#endif
		// LGE_Change_E, Fix for Camera AF tick noise issue TDID#76630, ranjith.k@lge.com - 18th Nov 2020
	}
