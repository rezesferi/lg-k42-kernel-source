...
//+bug577281 zhoumin.wt, add, 2020/9/2, add for bringup main af
...
extern int FP5510EAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long FP5510EAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int FP5510EAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int FP5510EAF_GetFileName(unsigned char *pFileName);

//+bug577281 zhoumin.wt, add, 2020/10/16, bringup second supply back camera:s5k3l6
extern int CN3927EAFA_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
			  spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long CN3927EAFA_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
		    unsigned long a_u4Param);
extern int CN3927EAFA_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int CN3927EAFA_GetFileName(unsigned char *pFileName);
//-bug577281 zhoumin.wt, add, 2020/10/16, bringup second supply back camera:s5k3l6
#endif
