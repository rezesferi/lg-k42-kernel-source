...
#define AW88164_LGE_FACTORY
#define AW88164_LGE_FACTORY_DEBUG

#ifdef AW88164_LGE_FACTORY
#define AW88164_CAL_STATUS_NOT_YET 0
#define AW88164_CAL_STATUS_DONE 1
#define AW88164_CAL_STATUS_RUNNING 2
#define AW88164_CAL_STATUS_FAIL 3
#endif
...
struct aw881xx {
	...
	uint16_t cfg_num;
#ifdef AW88164_LGE_FACTORY
	uint32_t dsp_fw_len[AW881XX_CFG_MODE_NUM];
	uint32_t dsp_cfg_len[AW881XX_CFG_MODE_NUM];
#else
	uint32_t dsp_fw_len;
	...
	char *name_suffix;
#ifdef AW88164_LGE_FACTORY
	struct completion fw_loading_completion;
	struct aw881xx_container *aw881xx_cfgs[AW881XX_CFG_MODE_NUM][AW881XX_MODE_CFG_NUM_MAX];
	bool spk_FW_loaded;
	bool voice_FW_loaded;
#endif
};
