...
#define	SMARTPA_SPK_DAC_VOLUME		_IOWR(TAS2563_MAGIC_NUMBER,\
						1, unsigned long)
#define	SMARTPA_SPK_POWER_ON		_IOWR(TAS2563_MAGIC_NUMBER,\
						2, unsigned long)
#define	SMARTPA_SPK_POWER_OFF		_IOWR(TAS2563_MAGIC_NUMBER,\
						3, unsigned long)
#define	SMARTPA_SPK_SWITCH_PROGRAM	_IOWR(TAS2563_MAGIC_NUMBER,\
						4, unsigned long)
#define	SMARTPA_SPK_SWITCH_CONFIGURATION _IOWR(TAS2563_MAGIC_NUMBER,\
						5, unsigned long)
#define	SMARTPA_SPK_SWITCH_CALIBRATION	_IOWR(TAS2563_MAGIC_NUMBER,\
						6, unsigned long)
#define	SMARTPA_SPK_SET_SAMPLERATE	_IOWR(TAS2563_MAGIC_NUMBER,\
						7, unsigned long)
#define	SMARTPA_SPK_SET_BITRATE		_IOWR(TAS2563_MAGIC_NUMBER,\
						8, unsigned long)
